...
#  How to run.
The Program input data file is included in the resources directory. Run the main method to see output.
Also there is a test case for shortest path assertion.

### Problem : Airport Baggage Routing
